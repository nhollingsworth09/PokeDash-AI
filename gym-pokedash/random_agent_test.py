...
class ModelAgent:
     ...
     def _build_model(self):
         ...
         model = load_model('C:/Users/nholl/Dropbox/2019 SPRING/Personal Projects/PyGame/Pokemon/best_player_3031.h5')
...
def model_agent(games = 10, frames = 5000):
    ...
    for __ in range(games):
        ...
        #agent.replay(np.min([len(agent.memory), 500]))        
...
def dqn_agent(games = 1000, frames = 5000):
    ...
    for __ in range(games):
        ...
        #agent.model.save('C:/Users/nholl/Dropbox/2019 SPRING/Personal Projects/PyGame/Pokemon/best_player.h5')
        
        model_breakThrough = history[-1][1] == np.max([score for game, score in history])
        
        if model_breakThrough:
            agent.model.save('C:/Users/nholl/Dropbox/2019 SPRING/Personal Projects/PyGame/Pokemon/best_player_{}.h5'.format(env.pika.score))
        else:
            pass
